                    ...
                    <div class="container">
                        <div class="row align-items-center">
                            <div class="col-md-6">
                                ...
                                <h6 class="wow fadeInUp" data-wow-delay=".5s"><span class="text-uppercase id-color-2">Krei</span></h6>
                                <div class="spacer-10"></div>
                                <h1 class="wow fadeInUp" data-wow-delay=".75s">Connecting<span class="id-color-2"> Artists </span>with <span class="id-color-2">Enjoyers</span></span></h1>
                                    
                                <div class="spacer-10"></div>
                                <a href="03_grey-explore.php" class="btn-main wow fadeInUp lead" data-wow-delay="1.25s">Explore</a>
            ...
            <section id="section-collections" class="pt30 pb30">
                <div class="container">
                            ...
                            <!-- <div class="row wow fadeIn"> 
                                        ...
                                        <div class="nft__item_wrap">
                                            <div class="nft__item_extra">
                                                <div class="nft__item_buttons">
                                                    <button onclick="location.href='03_grey-item-details.php'">Buy Now</button>
                                ...
                                <!-- <div class="d-item col-lg-3 col-md-6 col-sm-6 col-xs-12">
                                    <div class="nft__item style-2">
                                         <div class="de_countdown id-color" data-year="2022" data-month="12" data-day="15" data-hour="10"></div> 
                                        <div class="author_list_pp">
                                ...
                                <!-- <div class="d-item col-lg-3 col-md-6 col-sm-6 col-xs-12">
                                    <div class="nft__item style-2">
                                         <div class="de_countdown id-color" data-year="2022" data-month="12" data-day="8" data-hour="8"></div> 
                                        <div class="author_list_pp">
                                        ...
                                        <ol class="author_list">
                                            <li>                                    
                                                ...
                                                <div class="author_list_info">
                                                    <a href="03_grey-author.php">Monica Lucas</a>
                                                    <span>Rp50.000.000,00</span>
                                                </div>
                                            </li>
                                            <li>
                                                <div class="author_list_pp">
                                                ...
                                                <div class="author_list_info">
                                                    <a href="03_grey-author.php">Mamie Barnett</a>
                                                    <span>Rp20.000.800,00</span>
                                                </div>
                                            </li>
                                            <li>
                                                <div class="author_list_pp">
                                                ...
                                                <div class="author_list_info">
                                                    <a href="03_grey-author.php">Nicholas Daniels</a>
                                                    <span>Rp19.000.000,00</span>
                                                </div>
                                            </li>
                                            <li>
                                                <div class="author_list_pp">
                                                ...
                                                <div class="author_list_info">
                                                    <a href="03_grey-author.php">Lori Hart</a>
                                                    <span>Rp1.000.000,00</span>
                                                </div>
                                            </li>
                                            <li>
                                                <div class="author_list_pp">
                                                ...
                                                <div class="author_list_info">
                                                    <a href="03_grey-author.php">Jimmy Wright</a>
                                            ...
                                            <li>
                                                ...
                                                <div class="author_list_info">
                                                    <a href="03_grey-author.php">Karla Sharp</a>
                                                    <span>Rp240.000,00</span>
                                                </div>
                                            </li>
                                            <li>
                                                <div class="author_list_pp">
                                                ...
                                                <div class="author_list_info">
                                                    <a href="03_grey-author.php">Gayle Hicks</a>
                                            ...
                                            <li>
                                                ...
                                                <div class="author_list_info">
                                                    <a href="03_grey-author.php">Claude Banks</a>
                                                    <span>Rp230.000,00</span>
                                                </div>
                                            </li>
                                            <li>
                                                <div class="author_list_pp">
                                                ...
                                                <div class="author_list_info">
                                                    <a href="03_grey-author.php">Franklin Greer</a>
                                            ...
                                            <li>
                                                ...
                                                <div class="author_list_info">
                                                    <a href="03_grey-author.php">Stacy Long</a>
                                                    <span>Rp210.000,00</span>
                                                </div>
                                            </li>
                                            <li>
                                                <div class="author_list_pp">
                                                ...
                                                <div class="author_list_info">
                                                    <a href="03_grey-author.php">Ida Chapman</a>
                                            ...
                                            <li>
                                                ...
                                                <div class="author_list_info">
                                                    <a href="03_grey-author.php">Fred Ryan</a>
