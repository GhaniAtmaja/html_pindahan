                            ...
                            <div class="de-flex-col header-col-mid">
                                ...
                                <ul id="mainmenu">
                                    ...
                                    <!-- <li>
                                        ...
                                        <ul>
                                            <li><a href="03_grey-activity.ppp>Activity</a></li>
                                            <li><a href="03_grey-rankings.ppp>Rankings</a></li>
                                        </ul>
                                    </li> -->
                                </ul>
                                <!-- mainmenu close -->
                    ...
                    <div class="row g-5">
                        <div class="col-md-6 text-center">
                            <div class="nft-image-wrapper">
                                <img src="images/items/big-4.jpg" class="image-autosize img-fluid img-rounded mb-sm-30" alt="">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="item_info">
                                <!-- Auctions ends in <div class="de_countdown" data-year="2022" data-month="12" data-day="16" data-hour="8"></div> -->
                                <h2>AnimeSailorClub</h2>
                                    ...
                                    <div class="mr40">
                                        ...
                                        <div class="item_author">                                    
                                            ...
                                            <div class="author_list_info">
                                                <a href="03_grey-author.ppp>Monica Lucas</a>
                                            </div>
                                        </div>
                                    </div>
                                    <div>
                                        ...
                                        <div class="item_author">                                    
                                            <div class="author_list_pp">
                                                <a href="03_grey-collection.ppp>
                                                    <img class="lazy" src="images/collections/coll-thumbnail-1.jpg" alt="">
                                                    <i class="fa fa-check"></i>
                                                </a>
                                            </div>                                    
                                            <div class="author_list_info">
                                                <a href="03_grey-collection.ppp>AnimeSailorClub</a>
                                            </div>
                                        </div> -->
                                    </div>
                                </div>
                                ...
                                <div class="de_tab_content">
                                    <div class="tab-1">
                                        ...
                                        <div class="item_author">                                    
                                            ...
                                            <div class="author_list_info">
                                                <a href="03_grey-author.ppp>Stacy Long</a>
                                            </div>
                                        </div>
                                    ...
                                    <div class="tab-2">
                                        ...
                                        <div class="p_list">
                                            ...
                                            <div class="p_list_info">
                                                Requested <b>Picture for my profile❤️❤️</b>
                                        ...
                                        <div class="p_list">
                                            ...
                                            <div class="p_list_info">
                                                Requested <b>My favourite so far</b>
            ...
            <div class="modal-content">
              ...
              <div class="modal-body">
                <div class="p-3 form-border">
                    ...
                    <div class="spacer-single"></div>
                    <a href="03_grey-wallet.php target="_blank" class="btn-main btn-fullwidth">Add funds</a>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="modal-content">
              ...
              <div class="modal-body">
                <div class="p-3 form-border">
                    ...
                    <div class="spacer-single"></div>
                    <a href="03_grey-wallet.php target="_blank" class="btn-main btn-fullwidth">Place a bid</a>
                </div>
              </div>
            </div>
          </div>
