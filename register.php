                        ...
                        <div class="container">
                            <div class="row">
                                ...
                                <div class="col-md-12 text-center">
									<h1>Register</h1>
									<p>So You Can Make Your Own Art</p>
                                </div>
							...
							<form name="contactForm" id='contact_form' class="form-border" method="post" action='registerInput.php'>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="field-set">
                                            <label>Name:</label>
                                            <input type='text' name='P_NAMA' id='name' placeholder="Nama" class="form-control">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="field-set">
                                            ...
                                            <input type='text' name='P_EMAIL' id='email' placeholder="Email" class="form-control">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="field-set">
                                            <label>Phone:</label>
                                            <input type='text' name='P_TLP' id='phone' placeholder="Phone" class="form-control">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="field-set">
                                            <label>Bio:</label>
                                            <input type='text' name='P_BIO' id='username' placeholder="Bio" class="form-control">
                                        </div>
                                    </div>
